...
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("cake-contrib/Cake.PinNugetDependency", AppVeyor.Environment.Repository.Name);
...
Action<string, string> Package = (nuspec, basePath) =>
{
    ...
    NuGetPack(nuspec, new NuGetPackSettings {
        ...
        Version                  = semVersion,
        Tags                     = new [] {  "Cake", "Script", "Build", "NuGet" },
...
Action<string> SourceLink = (solutionFileName) =>
{
    GitLink("./", new GitLinkSettings() {
        RepositoryUrl = "https://github.com/cake-contrib/Cake.PinNuGetDependency",
...
Setup(context =>
{
    Information("Building version {0} of Cake.PinNugetDependency.", semVersion);
});
    ...
    .Does (() =>
{
    ...
    build("Cake.PinNuGetDependency.sln");
});
    ...
    .Does (() =>
{
    ...
    CreateAssemblyInfo(file, new AssemblyInfoSettings {
        Product = "Cake.PinNuGetDependency",
        Version = version,
        FileVersion = version,
...
{
    RestorePackages("./src/Cake.PinNuGetDependency.sln");
});
...
Task("RunUnitTests")
    ...
    .Does(() =>
{
    XUnit2("./src/Cake.PinNuGetDependency.Tests/bin/Release/Cake.PinNuGetDependency.Tests.dll", new XUnit2Settings {
        OutputDirectory = artifactDirectory,
        XmlReportV1 = false,
        NoAppDomain = true
    });
...
//    .IsDependentOn("RunUnitTests")
    .Does (() =>
{
    Package("./src/Cake.PinNuGetDependency.nuspec", "./src/Cake.PinNuGetDependency");
});
    ...
    .Does (() =>
{
    ...
    foreach(var package in new[] { "Cake.PinNuGetDependency" })
    {
